        ...
        <div className="bg-white p-6 md:p-8 rounded-lg shadow-xl">
            ...
            <div className="mb-6 border-b">
                <nav className="flex space-x-4">
                    <button onClick={() => { setActiveTab('menu'); setMenuView('list'); }} className={`py-2 px-4 text-sm font-medium ${activeTab === 'menu' ? 'border-b-2 border-primary-500 text-primary-600' : 'text-gray-500 hover:text-gray-700'}`}>
                        Gestionar Menú
                    </button>
            ...
            {activeTab === 'menu' && (
                menuView === 'list' 
                    ? <MenuManagementView /> 
                    : <MenuItemForm item={editingItem} onSave={handleFormClose} onCancel={handleFormClose} />
            )}
